...
review_list=[]
# csv 파일의 1행(카페이름) 읽기
file_dir = 'C:/Users/손병우/Desktop/crawl!/hotel_n.csv'
# encoding='utf-8'
...
ff = open(r'C:/Users/손병우/Desktop/Daedong_Mung!/withdog_edit.csv', 'w', encoding='CP949', newline='')
...
for place in cafe_name_list:
  ...
  try:
    if type=='애견동반':
      csvWriter.writerow([name, location,address,phone,type,review,menuInfo,hourInfo,link1,desc,main_img, mapx, mapy])
  except:
    if type=='애견동반':

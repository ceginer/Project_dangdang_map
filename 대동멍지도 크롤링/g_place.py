...
def crawl():
  url = "https://www.google.com/search?q="+query+'+강아지 여행지'+"&newwindow=1&tbm=lcl&sxsrf=ALiCzsbVCyPLmiOJs7RCE3tAYtQBG1I-Ow:1659626914458&ei=ouXrYtfJG5aw2roPl6qNgAU&start="+str(urlnum)
...
# 저장할 파일 지정
f = open(r"C:/Users/손병우/Desktop/Daedong_Mung!/test.csv", 'a', encoding='cp949', newline='')

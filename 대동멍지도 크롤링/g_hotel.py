...
def crawl():
  url = "https://www.google.com/search?q="+query+' 애견동반 호텔'+"&newwindow=1&tbm=lcl&sxsrf=ALiCzsbVCyPLmiOJs7RCE3tAYtQBG1I-Ow:1659626914458&ei=ouXrYtfJG5aw2roPl6qNgAU&start="+str(urlnum)
...
# 저장할 파일 지정
f = open(r"C:/Users/손병우/Desktop/crawl/hotel_g.csv", 'a', encoding='cp949', newline='')
...
location_list = ['서울','경기','인천','강원','충북','충남','대전','세종','전북','전남','광주','경북','경남','대구','울산','부산','제주']
